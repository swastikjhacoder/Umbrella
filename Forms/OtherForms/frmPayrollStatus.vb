...
#End Region
#Region "Form Events..."
    Private Sub frmPayrollStatus_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        LoadDate()
        LoadPeriod()
        ControlSetBound()
        LoadInstitute()
...
#Region "Button Events..."
    ...
    Private Sub btnimportexport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnimportexport.Click
        Dim frm As New frmImportExportPayroll()
        frm.FormBorderStyle = Windows.Forms.FormBorderStyle.FixedSingle
        frm.WindowState = FormWindowState.Normal
        frm.ControlBox = True
        frm.ShowDialog()
