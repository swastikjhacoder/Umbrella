...
#End Region
#Region "Class InstituteStatus..."
Public Class frmInstituteStatus
#Region "WithEvents..."
...
#End Region
#Region "Form Events..."
    Private Sub frmInstituteStatus_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadDate()
        LoadPeriod()
        ControlSetBound()
        LoadInstitute()
        ...
        End If
        If USYearEnd = "No Access" Then
            btnyearendwizard.Enabled = False
        End If
...
#Region "Button Events..."
    ...
    Private Sub btnyearendwizard_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnyearendwizard.Click
        Dim frm As New frmYearEndWizard()
        frm.FormBorderStyle = Windows.Forms.FormBorderStyle.FixedSingle
        frm.WindowState = FormWindowState.Normal
        frm.ControlBox = True
        frm.Show()
