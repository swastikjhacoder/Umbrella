#Region "Class frmSetupDefaultsLibrary..."
Public Class frmSetupDefaultsLibrary
#Region "Declarations..."
    Private DGVAccount As New DataGridView()
#End Region
#Region "Methods..."
    Private Sub ControlSetBound()
        Label1.SetBounds(29, 23, 200, 13)
        chkautuid.SetBounds(32, 31, 398, 30)
        cmbaccount.SetBounds(235, 20, 121, 21)
    End Sub
    ...
    Private Sub LoadRecord()
        Try
            ...
            End If
            cmbaccount.Text = dr("chargesaccount").ToString()
            dr.Close()
        Catch ex As Exception
            dr.Close()
        End Try
        ...
        Try
            ...
            Else
                ...
                If result = Windows.Forms.DialogResult.Yes Then
                    ...
                    cls.UpdateLibraryDefault(My.Settings.LastOpenedInstituteID, My.Settings.LastOpenedInstitute, My.Settings.Period, autoid, cmbaccount.Text)
                    If cls.UpdateLibraryDefaultOk = True Then
                        ...
                        If result1 = Windows.Forms.DialogResult.OK Then
                            LSDAutoID = autoid
                            LSDChargesAccount = cmbaccount.Text
                            Me.Close()
                        End If
                    End If
                End If
...
#End Region
#Region "Form Events..."
    Private Sub frmSetupDefaultsLibrary_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ControlSetBound()
        LoadAccounts()
        LoadRecord()
        If USLibraryDefault = "View Only" Then
