...
#Region "Methods..."
    ...
    Public Function CodeIncrement(ByVal CODE As String) As String
        ...
        Temp += 1
        TT = String.Format("LTF:{0:00000000}", Temp)
        Return TT
    End Function
    ...
    Private Sub ControlSetBound()
        ...
        Label6.SetBounds(10, 105, 127, 13)
        ...
        txtreason.SetBounds(143, 105, 280, 63)
    ...
    Private Sub LoadLateFees(ByVal StId As String)
        Try
            ...
            dgviewmonthly.Rows(0).Cells(0).Value = ISDLateFeesAccount
            dgviewmonthly.Rows(0).Cells(1).Value = "Late Fees:"
            ...
            dgviewmonthly.Rows(3).Cells(0).Value = ISDLateFeesAccount
    ...
    Private Sub LoadLateFees(ByVal course As String, ByVal clas As String, ByVal roll As String)
        Try
            dgviewmonthly.Rows.Clear()
            dgviewmonthly.Rows.Add()
            dgviewmonthly.Rows.Add()
    ...
    Private Sub CheckPaid()
        Try
            ...
            Dim month As Integer = dt.Month
            Dim year As Integer = dt.Year
            cmd.CommandText = "select paid from LateFees where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and Period='" & My.Settings.Period & "' and date='" & cmbdate.Text & "' and month=" & month & " and year=" & year & " and course='" & cmbcourse.Text & "' and regno='" & StuID & "' and name='" & txtname.Text & "'"
            dr = cmd.ExecuteReader
            If dr.Read() Then
                ...
                If result = Windows.Forms.DialogResult.Yes Then
                    ...
                    If TokenExist = False Then
                        ...
                        If CDec(dgviewmonthly.Rows(0).Cells(2).Value.ToString()) = 0.0 Then
                            laters = 0.0
                        Else
                            laters = CDec(dgviewmonthly.Rows(0).Cells(2).Value.ToString())
                        End If
                        ...
                        End If
                    Else
                        Dim result1 As DialogResult = MessageBox.Show("Token no. already exist." + "Please enter a new token no.", "Umbrella - Duplicate Value", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                        If result1 = Windows.Forms.DialogResult.OK Then
                            txtpaid.Focus()
                        End If
                    End If
    ...
    Private Sub AddDiscount()
        Try
            ...
            Dim month As Integer = dt.Month
            Dim year As Integer = dt.Year
            cls.AddRecord(My.Settings.LastOpenedInstituteID, My.Settings.LastOpenedInstitute, My.Settings.Period, UmbrellaSystemDate, txttoken.Text, dt.ToShortDateString(), month, year, appliedfor, cmbclass.Text, cmbroll.Text, StuID, StuName, totalamt, discch, disc, disc, cmbpayvia.Text, authentication, remarks, ISDDiscountFeesAccount)
        ...
        Try
            ...
            Else
                ...
                If result = Windows.Forms.DialogResult.Yes Then
                    ...
                    If cls.UpdateLateFeesOk = True Then
                        cmd.CommandText = "update Accounts set AccountBalance=AccountBalance-" & TotalPaid & " where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and Period='" & My.Settings.Period & "' and AccountID='" & ISDLateFeesAccount & "'"
                        dr = cmd.ExecuteReader
                        dr.Close()
                        ...
                        dr = cmd.ExecuteReader
                        dr.Close()
                        cmd.CommandText = "update Accounts set AccountBalance=AccountBalance+" & CDec(txtpaid.Text) & " where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and Period='" & My.Settings.Period & "' and AccountID='" & ISDLateFeesAccount & "'"
                        dr = cmd.ExecuteReader
                        dr.Close()
                        Dim description As String = "Late Fees"
                        Dim type As String = "Income"
        ...
        Try
            ...
            Else
                ...
                If result = Windows.Forms.DialogResult.Yes Then
                    ...
                    If cls.DeleteLateFeesOk = True Then
                        cmd.CommandText = "update Accounts set AccountBalance=AccountBalance-" & TotalPaid & " where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and Period='" & My.Settings.Period & "' and AccountID='" & ISDLateFeesAccount & "'"
                        dr = cmd.ExecuteReader
                        dr.Close()
                        cmd.CommandText = "update Accounts set AccountBalance=AccountBalance+" & Discount & " where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and Period='" & My.Settings.Period & "' and AccountID='" & ISDDiscountFeesAccount & "'"
    ...
    Private Sub LoadSelectedRecord()
        Try
            ...
            dgviewmonthly.Rows.Add()
            dgviewmonthly.Rows.Add()
            cmd.CommandText = "select * from LateFees where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and Period='" & My.Settings.Period & "' and regno='" & StuID & "' and date='" & latefeesdate & "' and totalamt=" & latefeesamount & " and transactionid='" & transactionid & "'"
            dr = cmd.ExecuteReader
            If dr.Read() Then
                dt = dr("date").ToString()
                ...
                Dim laters As Decimal = CDec(dr("laters").ToString())
                dgviewmonthly.Rows(0).Cells(0).Value = ""
                dgviewmonthly.Rows(0).Cells(1).Value = "Late Fees:"
                dgviewmonthly.Rows(0).Cells(2).Value = FormatNumber(laters.ToString())
                LateFee = laters
    ...
    Private Sub CheckTokenNo()
        Try
            cmd.CommandText = "select * from LateFees where transactionid='" & txttoken.Text & "' and InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and Period='" & My.Settings.Period & "'"
            dr = cmd.ExecuteReader
            If dr.Read() Then
                TokenExist = True
            Else
    ...
    Private Sub cmbroll_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cmbroll.KeyDown
        If e.KeyCode = Keys.Enter Then
            If cmbclass.Text <> "" And cmbcourse.Text <> "" And cmbroll.Text <> "" Then
                LoadLateFees(cmbcourse.Text, cmbclass.Text, cmbroll.Text)
...
#End Region
#Region "Form Events..."
    Private Sub frmLateFees_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If updatelatefees = False Then
            ControlSetBound()
            LoadCourse()
            If ISDAutoID = "Yes" Then
