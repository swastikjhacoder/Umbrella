#Region "Class frmViewEditStaffAttendance..."
Public Class frmViewEditStaffAttendance
#Region "Methods..."
    ...
    Private Sub LoadDataGrid()
        Try
            Dim i As Integer = 0
            dgviewattendance.Rows.Clear()
            cmd.CommandText = "select empid,name from Employee where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and SystemDate<='" & UmbrellaSystemDate & "'"
    ...
    Private Sub LoadAttendance()
        Try
            ...
            For i As Integer = 0 To row - 1
                cmd.CommandText = "select * from EmployeeAttendance where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and Period='" & My.Settings.Period & "' and empid='" & dgviewattendance.Rows(i).Cells(0).Value.ToString() & "' and name='" & dgviewattendance.Rows(i).Cells(1).Value.ToString() & "' and day1name='" & dgviewattendance.Columns(2).HeaderText & "' and SystemDate<='" & UmbrellaSystemDate & "'"
                dr = cmd.ExecuteReader
                If dr.Read() Then
        ...
        Try
            ...
            If result = DialogResult.Yes Then
                ...
                For i As Integer = 0 To dgviewattendance.Rows.Count - 1
                    ...
                    cls.UpdateEmployeeAttendace(InsID, InsName, periodd, My.Settings.FinancialPeriod, empid, name, day1name, day1atten, day2name, day2atten, day3name, day3atten, day4name, day4atten, day5name, day5atten, day6name, day6atten, day7name, day7atten)
                Next
                If cls.UpdateOk = True Then
                    ...
                    If result1 = DialogResult.OK Then
                        LoadDate()
                        EGroupBox1.GroupTitle = "Staff Attendance from " + cmbfrom.Text + " to " + cmbto.Text
