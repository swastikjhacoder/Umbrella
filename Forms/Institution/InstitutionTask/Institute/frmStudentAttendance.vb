#Region "Class frmStudentAttendance..."
...
#Region "Methods..."
    ...
    Private Sub LoadDataGrid()
        Try
            Dim i As Integer = 0
            dgviewattendance.Rows.Clear()
            cmd.CommandText = "select stuid,name from StudentRegistration where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "'"
    ...
    Private Sub LoadAttendance()
        Try
            ...
            For i As Integer = 0 To row - 1
                cmd.CommandText = "select * from StudentAttendance where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and Period='" & My.Settings.Period & "' and stuid='" & dgviewattendance.Rows(i).Cells(0).Value.ToString() & "' and name='" & dgviewattendance.Rows(i).Cells(1).Value.ToString() & "' and day1name='" & dgviewattendance.Columns(2).HeaderText & "'"
                dr = cmd.ExecuteReader
                If dr.Read() Then
        ...
        Try
            ...
            If result = DialogResult.Yes Then
                ...
                For i As Integer = 0 To dgviewattendance.Rows.Count - 1
                    ...
                    cls.SaveStudentAttendace(InsID, InsName, periodd, UmbrellaSystemDate, studentid, name, day1name, day1atten, day2name, day2atten, day3name, day3atten, day4name, day4atten, day5name, day5atten, day6name, day6atten, day7name, day7atten)
                Next
                If cls.SaveStuOk = True Then
...
#End Region
#Region "Form Events..."
    Private Sub frmStudentAttendance_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        LoadDate()
        EGroupBox1.GroupTitle = "Student Attendance from " + cmbdate.Text
