#Region "Class frmViewEditEmployee..."
Public Class frmViewEditEmployee
#Region "Methods..."
    Private Sub LoadDataGrid()
        Try
            Dim i As Integer = 0
            dgviewemployee.Rows.Clear()
            cmd.CommandText = "select empid,name,designation,payinfo,payscale,department,joiningdate,retirementdate,fulladdress,phone from Employee where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and SystemDate<='" & UmbrellaSystemDate & "'"
    ...
    Private Sub TotalEmployee()
        Try
            ...
            EGroupBox1.GroupTitle = "Employee List: " + row.ToString()
        Catch ex As Exception
