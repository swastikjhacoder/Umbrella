#Region "Class frmRetiredEmployeeList..."
Public Class frmRetiredEmployeeList
#Region "Methods..."
    Private Sub LoadDataGrid()
        Try
            Dim i As Integer = 0
            dgviewemployee.Rows.Clear()
            cmd.CommandText = "select empid,name,designation,payinfo,payscale,department,joiningdate,retirementdate,fulladdress,phone from RetiredEmployee where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and SystemDate<='" & UmbrellaSystemDate & "'"
            ...
            While dr.Read()
                ...
                dgviewemployee.Rows(i).Cells(4).Value = dr("payscale").ToString()
    ...
    Private Sub TotalEmployee()
        Try
            ...
            EGroupBox1.GroupTitle = "Retired Employee List: " + row.ToString()
        Catch ex As Exception
    ...
    Private Sub OpenRecords()
        Try
            ...
            Dim frm As New frmRetiredEmployee()
...
#End Region
#Region "Form Events..."
    Private Sub frmRetiredEmployeeList_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        LoadDataGrid()
        TotalEmployee()
    End Sub
#End Region
