#Region "Class frmViewEdit_CertificateEmployee..."
Public Class frmViewEdit_CertificateEmployee
#Region "Methods..."
    Private Sub LoadDataGrid()
        Try
            Dim i As Integer = 0
            dgviewcertificate.Rows.Clear()
            cmd.CommandText = "select certificateid,regno,name,certificatefor,issuedate from EmployeeCertificate where InsID='" & My.Settings.LastOpenedInstituteID & "' and InsName='" & My.Settings.LastOpenedInstitute & "' and Period='" & My.Settings.Period & "' and SystemDate<='" & UmbrellaSystemDate & "'"
    ...
    Private Sub OpenRecords()
        Try
            ...
            Dim frm As New frmCertificateEmployee()
...
#End Region
#Region "Form Events..."
    Private Sub frmViewEdit_CertificateEmployee_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        LoadDataGrid()
        TotalCertificates()
    End Sub
#End Region
