...
#Region "Properties"
        ...
        <Category("Appearance")> _
        <DefaultValue(GetType(Color), "InactiveBorder")> _
...
#Region "Event Methods"
        ...
        Protected Overrides Sub OnTextChanged(ByVal e As EventArgs)
            searchImage.Image = If(TextEntered, Global.Umbrella.My.Resources.active_search, Global.Umbrella.My.Resources.inactive_search)
